...
public class TasksLoader extends AsyncTaskLoader<List<TaskPlant>> {

	// We hold a reference to the Loader’s data here.
	private List<TaskPlant> mData;

	public TasksLoader(Context ctx) {
	...
	@Override
	public List<TaskPlant> loadInBackground() {
		// This method is called on a background thread and should generate a
		// new set of data to be delivered back to the client.
		List<TaskPlant> data = new ArrayList<TaskPlant>();

		// Perform the query here and add the results to 'data'.
		TaskPlantDao tpd = new TaskPlantDao(getContext());
		data = tpd.getAllTaskPlant();
		return data;
	}
	...
	@Override
	public void deliverResult(List<TaskPlant> data) {
		if (isReset()) {
	...
	@Override
	public void onCanceled(List<TaskPlant> data) {
	...
	private void releaseResources(List<TaskPlant> data) {
	...
	private void registerReceiver() {
		...
		LocalBroadcastManager.getInstance(getContext()).registerReceiver(
				mMessageReceiver, new IntentFilter("taskplant-database-changed"));
